...
#     'P' => get_trade_message,
#     'I' => get_noii_message,
#     'T' => get_timestamp_message,
#     'S' => get_system_event_message,
#     'H' => get_trade_action_message,
#     'A' => get_add_message,
#     'F' => get_add_mpid_message,
#     'E' => get_execute_message,
#     'C' => get_execute_price_message,
#     'X' => get_cancel_message,
#     'D' => get_delete_message,
#     'U' => get_replace_message,
#     'Q' => get_cross_trade_message
# )

get_message_size(io) = Int(ntoh(read(io, UInt16)))
get_message_type(io) = Char(read(io, Char))

# function get_message(io, type, date, sec, version)
#     getter = get(CONSTRUCTORS, type, nothing)
#     if isnothing(getter)
#         warn("unsupported message type \'$type\' found——skipping")
#         return nothing
#     end
#     return getter(io, date, sec)
# end
